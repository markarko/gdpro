 ...
 * @returns {Promise<Array<Object>>} - A promise that resolves with an array of objects representing the parsed CSV rows
 ...
 * @returns {Promise<Array<Object>>} - A promise that resolves with an array of objects representing the parsed CSV content
 ...
 * 
 * @param {string} fileName - The name of the CSV file. The file should be located in 'server/data/' 
 * @returns {Promise<Array<Object>>} - A promise that resolves with an array of objects representing the parsed CSV content
